...
#else
typedef void (*p_btMotionState_getWorldTransform)(void* managedMotionState, btTransform* worldTrans);
typedef void (*p_btMotionState_setWorldTransform)(void* managedMotionState, const btTransform* worldTrans);
