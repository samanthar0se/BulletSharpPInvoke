...
{
	public class b3GpuRigidBodyPipeline
	{
		public B3GpuRigidBodyPipeline(int ctx, int device, int q, b3GpuNarrowPhase^ narrowphase, b3GpuBroadphaseInterface^ broadphaseSap, b3DynamicBvhBroadphase^ broadphaseDbvt, int^ config)
		{
		}
		...
		public void RegisterPhysicsInstance(float mass, float^ position, float^ orientation, int collisionShapeIndex, int userData, bool writeInstanceToGpu)
		{
		}
