...
{
	public class CompoundCompoundCollisionAlgorithm
	{
		public CompoundCompoundCollisionAlgorithm(btCollisionAlgorithmConstructionInfo^ ci, btCollisionObjectWrapper^ body0Wrap, btCollisionObjectWrapper^ body1Wrap, bool isSwapped)
		{
		}
