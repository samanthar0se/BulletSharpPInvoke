...
{
	public class SoftSoftCollisionAlgorithm
	{
		public SoftSoftCollisionAlgorithm(int^ ci)
		{
		}
		public SoftSoftCollisionAlgorithm(btPersistentManifold^ mf, int^ ci, int^ body0Wrap, int^ body1Wrap)
		{
		}
